...
class Settings(BaseSettings):
    ...
    minio_secret_key: str = "minio577715"  # MinIO 的密钥
    ...
    embedding_api_key: str = "your-api-key-here"  # OpenRouter API密钥
